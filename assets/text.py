...
classes_text = """Origem: 
    [1] Sobrevivente com Machadinha
    [2] Soldado com Espada
    [3] Estudioso com Cajado
    [4] Caçador com Lança"""

menu_text = """            [1]Explorar
            [2]Ver Atributos
            [3]Ver Inventario
            [4]Usar Item
            [5]Loja
            ...
            [8]Enfrentar Chefe
            --------------------------
            [9]Carregar ultimo save
            [10]Salvar jogo
            --------------------------
            [11]Encerrar jogo e salvar
            --------------------------
            [12]deletar save e resetar"""

fight_options_text = """    [1] Atacar
    [2] Defender
    [3] Item
    [4] Fugir"""
